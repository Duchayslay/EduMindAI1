...
// ĐỒNG BỘ IMPORT: Sử dụng đúng định danh package hệ thống để nhận diện trùng Type
...
class Calendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // SỬA TẠI ĐÂY: Dùng Builder để lấy đúng BuildContext nằm DUỚI AppSettingsProvider
    // đã được bọc ở MyCalendar ngoài màn hình chính.
    return Builder(
      builder: (innerContext) {
        return CalendarScope(
          child: Builder(
            builder: (scopeContext) => EventDetailOverlay(
              location: scopeContext.location.value,
